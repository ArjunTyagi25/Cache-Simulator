...
{
    private:
        /// @brief Size of memory in bytes (B)
        size_t memory_size;
        /// @brief Size of a page in bytes (B)
        size_t page_size;
        /// @brief Size of a memory line in bytes (B)
        size_t line_size;
        /// @brief Number of pages in the memory
        size_t number_of_pages;
        /// @brief Number of bits in the address for page offset
        size_t page_offset_bits;
        /// @brief Vector holding all the pages in the memory
