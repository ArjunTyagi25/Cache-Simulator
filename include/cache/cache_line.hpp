...
class cache_line
{
    private:
        ...
        size_t line_size;
        /// @brief Tag associated with the cache line
        size_t tag;
        /// @brief Valid bit of the cache line
        bool valid; 
        /// @brief Dirty bit of the cache line
        bool dirty;
        /// @brief Vector holding the data of the cache line
    ...
    public:
        ...
        /**
         * @brief Destroy the cache line object
         */
        ~cache_line() = default;
